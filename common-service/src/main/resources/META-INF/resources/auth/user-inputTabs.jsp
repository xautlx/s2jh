...
<div class="tabbable tabbable-custom tabbable-secondary">
	<ul class="nav nav-tabs">
		...
		<li><a data-toggle="tab" href="${base}/auth/user!roles?id=<s:property value='#parameters.id'/>">角色关联</a></li>
		<li><a data-toggle="tab" href="${base}/auth/user!privileges?id=<s:property value='#parameters.id'/>">权限汇总</a></li>		
	</ul>
</div>
