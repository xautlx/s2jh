	...
	<div class="row-fluid">
		<div class="toolbar">
			<div class="toolbar-inner">
				<button type="button" class="btn btn-submit" callback-tab="userIndexTabs" callback-grid="userListDiv">
	...
	<div class="well auto-stretch">
		...
		<s:if test="persistentedModel">
			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						<label class="control-label" for="updatePassword<s:property value='#parameters.id'/>"> </label>
						<div class="controls">
							<label class="checkbox inline"> <input id="updatePassword<s:property value='#parameters.id'/>"
								type="checkbox" value="op" name="updatePassword"> 修改密码
							</label>
						</div>
					</div>
				</div>
			...
			<div id="passwordDiv<s:property value='#parameters.id'/>" class="row-fluid hide">
				<div class="span6">
					<s2:password name="newpassword" label="设置密码" requiredLabel="true" validator="{minlength:3}" disabled="true" />
				</div>
				<div class="span6">
					<s2:password name="cfmpassword" label="重复密码" requiredLabel="true" validator="{equalToByName:'newpassword'}"
						disabled="true" />
				</div>
			</div>
		</s:if>
