...
<#if parameters.leftTitle??><#t/>
	<label for="leftTitle" class="ui-widget-header ui-corner-top ui-helper-clearfix">${parameters.leftTitle}</label>
	<div style="100%"><INPUT NAME=regexp onKeyUp="filter_${parameters.id?html}.set(this.value)" class="search_text" style="width:98%"></div>
</#if><#t/>
...
<#if parameters.rightTitle??><#t/>
	<label for="rightTitle" class="ui-widget-header ui-corner-top ui-helper-clearfix">${parameters.rightTitle}</label>
	<div style="100%"><INPUT NAME=regexp onKeyUp="filter_${parameters.doubleId?html}.set(this.value)" class="search_text" style="width:98%"></div>
</#if><#t/>
<select
    ...
    <#else><#t/>
    ondblclick="moveSelectedOptions(document.getElementById('${parameters.doubleId?html}'), document.getElementById('${parameters.id?html}'), false, '');"
    </#if><#t/>
...
var filter_${parameters.id?html} = new filterlist($("#${parameters.id?html}").get(0));
var filter_${parameters.doubleId?html} = new filterlist($("#${parameters.doubleId?html}").get(0));
</script>
</td>
</tr>
</table>
