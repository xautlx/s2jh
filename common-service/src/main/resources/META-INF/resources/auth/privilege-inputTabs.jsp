...
<div class="tabbable tabbable-custom tabbable-secondary">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a data-toggle="tab"
			href="${base}/auth/privilege!edit?id=<s:property value='#parameters.id'/>&clone=<s:property value='#parameters.clone'/>">基本信息</a></li>
		<li><a data-toggle="tab" data-tab-disabled="<s:property value='%{!persistentedModel}'/>"
			href="${base}/auth/privilege!roles?id=<s:property value='#parameters.id'/>">角色关联</a></li>
	</ul>
</div>
